...
CREATE TABLE IF NOT EXISTS loads (
    ...
    pickup_type             VARCHAR CHECK (pickup_type IN ('BUSINESS','RESIDENCE','AUCTION','PORT','DEALER','OTHER')),
    drop_type               VARCHAR CHECK (drop_type   IN ('BUSINESS','RESIDENCE','AUCTION','PORT','DEALER','OTHER')),
