...
If you want I can:
- Add a small Cypress or Playwright flow that exercises validate->preview->save using the currently running app.
- Convert `allowedToOperate` in the preview to boolean for frontend convenience.
- Provide ready-to-use React components (small) to render the preview and the save form.

*** End of frontend-sample.md
